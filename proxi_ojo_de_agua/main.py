...
JSON_AGENCIA = r"C:\Users\infob\Desktop\inventarios\agencias\ojo_de_agua\inventario_render.json"
...
@app.route("/")
def home():
    return "Servidor PROXI JQ Motors OJO DE AGUA activo."
...
def actualizar_desde_matriz():
    ...
    inventario_final = [{"codigo": i.get("codigo",""), "descripcion": i.get("descripcion",""), "stock": i.get("stock",0), "agencia": "ojo_de_agua"} for i in inventario_real]
    guardar_inventario(inventario_final)
    return jsonify({"status": "actualizado"})
